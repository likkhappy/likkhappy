 ...
 * @history:
 */
define("app/TestSwfUpload", [ "lib/SwfUpload", "util/swf/fileprogress", "util/swf/handlers" ], function(require, exports, module) {
    var swfUpload = require("lib/SwfUpload"), progress = require("util/swf/fileprogress"), handler = require("util/swf/handlers");
    var settings = {
