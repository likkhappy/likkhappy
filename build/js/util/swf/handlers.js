 ...
 ********************** */
define("util/swf/handlers", [ "util/swf/fileprogress" ], function(require, exports, module) {
    var progress = require("util/swf/fileprogress");
    function fileQueued(file) {
        try {
            var progress = new progress(file, this.customSettings.progressTarget);
